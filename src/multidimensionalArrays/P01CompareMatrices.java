...
public class P01CompareMatrices {
    public static void main(String[] args) {
        ...
        int firstRows = Integer.parseInt(firstInput[0]);
        int firstCols = Integer.parseInt(firstInput[1]);
        ...
        int secondRows = Integer.parseInt(secondInput[0]);
        int secondCols = Integer.parseInt(secondInput[1]);
